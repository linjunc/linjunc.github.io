            ...
            '/pages/react/hard/': [
                {
                    ...
                    collapsable: false,
                    items: [
                        { link: '/pages/react/hard/start.md', text: '专栏介绍' }
                    ]
                },
                {
                    text: 'React 哲学', // 必要的
                    ...
                    items: [
                        ...
                        { link: '/pages/react/hard/constructure.md', text: 'React Fiber 架构' },
                    ]
                },
                {
                    text: 'Render 阶段',
                    ...
                    sidebarDepth: 2, // 可选的, 默认值是 1
                    items: [
                        { link: '/pages/react/hard/beginwork.md', text: 'Render 阶段 -- Beginwork' },
                        { link: '/pages/react/hard/completework.md', text: 'Render 阶段 -- Completework' },
                    ]
                },
                {
                    text: 'Commit 阶段',
                    ...
                    items: [
                        ...
                        { link: '/pages/react/hard/beforemutation.md', text: 'Before Mutation 阶段' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { link: '/pages/react/hard/singlediff.md', text: '单一节点的 Diff' },
                ...
                },
                {
                    ...
                    items: [
                        ...
                        { link: '/pages/react/hard/updatecode.md', text: '状态更新调度源码解析' },
                    ]
                },
                {
                    text: 'Scheduler 模块',
                    ...
                    sidebarDepth: 2,
                    items: [
                        { link: '/pages/react/hard/writing.md', text: 'Scheduler 核心流程概览' },
                        { link: '/pages/react/hard/writing.md', text: 'Scheduler 调度源码解析' },
                    ]
                },
                {
                    text: 'Hooks 实现',
                    ...
                    items: [
                        ...
                        { link: '/pages/react/hard/writing.md', text: 'useContext 源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useState  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useReducer  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useLayoutEffect  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useEffect  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useRef  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useMemo  源码解读' },
                        { link: '/pages/react/hard/writing.md', text: 'useCallback  源码解读' },
                    ]
                },
                {
                    text: '事件系统',
                    ...
                    sidebarDepth: 2,
                    items: [
                        { link: '/pages/react/hard/writing.md', text: 'React 事件系统概览' },
                        { link: '/pages/react/hard/writing.md', text: 'React 事件系统源码解析' },
                    ]
                },
                {
                    text: 'Context 状态原理',
                    ...
                    sidebarDepth: 2,
                    items: [
                        { link: '/pages/react/hard/writing.md', text: 'Context 状态原理概览' },
                        { link: '/pages/react/hard/writing.md', text: 'Context 状态原理源码解析' },
                    ]
                },
                {
                    text: 'React 全家桶',
                    ...
                    sidebarDepth: 2,
                    items: [
                        { link: '/pages/react/hard/writing.md', text: 'React Redux 源码解析' },
                        { link: '/pages/react/hard/writing.md', text: 'React MobX 源码解析' },
                        { link: '/pages/react/hard/writing.md', text: 'React Router 源码解析' },
            ...
            '/pages/summary/': [
                {
                    ...
                    sidebarDepth: 2, // 可选的, 默认值是 1
                    items: [
                        {link:'/pages/summary/event.md', text:'Event 对象，这些你都知道吗？'},
                        {link:'/pages/summary/qrcode.md', text:'如何优雅的在 H5 网页中实现扫码功能'},
                        {link:'/pages/summary/animate.md', text:'为什么 CSS 动画比 JavaScript 高效？'},
                        {link:'/pages/summary/git.md',text: '通俗易懂的GIT入门'},
                        {link:'/pages/summary/prototype.md',text: '三张图轻松KO⚡ JS 原型和原型链'},
                        {link:'/pages/summary/v8.md', text:'你知道 V8 是如何执行JS代码的吗？'},
                        {link:'/pages/summary/weakmap.md', text:'浅析 Map 和 WeakMap 区别以及使用场景'},
                        {link:'/pages/summary/jsrun.md',text: '新生代总结 JavaScript 运行机制解析'},
                        {link:'/pages/summary/inherit.md',text: 'JS 继承的7种方法，你学会了吗？'},
                        {link:'/pages/summary/arrayapi.md', text:'原生 JavaScript 手写数组 API'},
                        {link:'/pages/summary/iterator.md',text: '【深扒】JavaScript 中的迭代器'},
                        {link:'/pages/summary/generator.md',text: '【深扒】JavaScript 中的生成器'},
                        {link:'/pages/summary/highf.md',text: 'JavaScript中的高阶函数'},
                        {link:'/pages/summary/npm.md',text: '经常使用npm命令，你真的知道它的意思吗？'},
                        {link:'/pages/summary/storage.md', text:'Javascript客户端存储技术你知道多少？'}
                    ]
                }
            ],
            '/pages/about/': [
            ...
            '/pages/structure/': [
                {
                    ...
                    sidebarDepth: 2, // 可选的, 默认值是 1
                    items: [
                        { link:'/pages/structure/start.md',text: '从这里开启数据结构和算法'},
                        { link:'/pages/structure/stack.md', text:'详解栈结构，并实现一个栈结构'},
                        { link:'/pages/structure/queue.md',text: '详解队列结构，并实现一个队列结构'},
                        { link:'/pages/structure/link.md', text:'详解链表结构，并实现一个链表结构'},
                        { link:'/pages/structure/set.md',text: '详解集合结构，并实现一个集合'},
                        { link:'/pages/structure/map.md', text:'详解字典结构，并实现一个字典'},
                        { link:'/pages/structure/tree.md',text: '详解树结构，并实现二叉搜索树'},
                        { link:'/pages/structure/graph.md',text: '详解图结构，并实现一个图结构'},
