---
title: React 入门学习（三） -- 组件的生命周期
date: 2021-8-22 16:11:56
id: 1635581516
tags:
  - react
  - 生命周期
categories:
  - React入门学习
keywords: react,组件的生命周期,小丞同学
description: 在 React 中为我们提供了一些生命周期钩子函数，让我们能在 React 执行的重要阶段，在钩子函数中做一些事情。
---

![react-study-lifecycle](https://ljcimg.oss-cn-beijing.aliyuncs.com/img/react-study-lifecycle.png)
